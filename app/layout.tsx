...
export const metadata: Metadata = {
  title: "Imageverse",
  description: "Imageverse  AI-powered image generation and marketing visuals",
  icons: {
    icon: "/favi1.png",
  },
  openGraph: {
    title: "Imageverse",
    description: "Create perfect marketing images in seconds with AI-powered styles and exports.",
  },
};
